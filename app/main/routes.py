...
from flask import current_app, g, flash, jsonify, request, redirect, \
...
def index():
    ...
    return render_template('index.html', title=_('Home Page'), 
            сurrent_user=current_user, # current_user don't exist in the book
...
def explore():
    ...
    prev_url = url_for('main.explore', page=posts.prev_num) \
        if posts.has_prev else None
    return render_template('index.html', current_user=current_user, # current_user wasn't in the book
...
def export_posts():
    if current_user.get_task_in_progress('export_posts'):
        ...
        current_user.launch_task('export_posts', _('Exporting...'))
        db.session.commit()
